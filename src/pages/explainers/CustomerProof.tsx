// Explainers — real customer proof. Siemens figures + real quote, carried over
// from the verified LP2 customer module (count-up on scroll-into-view). This is
// real customer content, so it stands in for the wireframe's placeholder
// testimonial — nothing here is invented.
...
export default function CustomerProof() {
  ...
  return (
    <div className="bg-white flex flex-col gap-16 md:gap-[97px] items-center justify-center py-[72px] md:py-[104px] w-full px-6 xl:px-0">
      ...
      {/* Testimonial quote — real, from the verified LP2 module */}
