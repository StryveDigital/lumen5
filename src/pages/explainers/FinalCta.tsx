// Explainers — final dark CTA module. Mirrors the shared CTA-module shell used
// across the LPs (decorative shapes peeking from the edges).
  ...
  return (
    <div className="bg-[#201e26] relative w-full overflow-hidden" style={{ minHeight: 432 }}>
      <div className="flex flex-col gap-3 items-center justify-center py-[72px] md:py-[104px] px-6 md:px-16 relative z-10">
        <h2 className="font-heading font-semibold text-[28px] leading-[36px] md:text-[42px] md:leading-[60px] text-[#fafafa] text-center w-full max-w-[860px]">
          The complicated thing you&rsquo;ve been putting off? Explain it today.
        </h2>
        <p className="font-body font-normal text-[18px] leading-[30px] md:text-[20px] md:leading-[36px] text-[#fafafa] text-center w-full max-w-[669px]">
          Describe it, or paste a doc. Your first animated explainer is one afternoon away.
        </p>
