...
const cards: Card[] = [
  ...
  {
    eyebrow: 'Launch Page · Explainers',
    title: 'Finally. Explainer videos anyone can make.',
    desc: 'The ad-driven launch page for Animated Explainers — WOW hero, real beta-customer proof, three-step demo, and cost reframe.',
    href: '/explainers',
  },
  {
