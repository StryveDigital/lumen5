// LP2 — Webinars hero. Right-side illustration is a single designer-provided
// SVG (replaces the previous composite of ~10 Figma MCP asset URLs).

import { CTA } from '../../shared/cta-urls';

const imgBannerIllustration = "/lp2-banner.svg";
