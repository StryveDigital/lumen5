...
export default function TwoCardCta() {
  return (
    <div className="bg-[#201e26] relative w-full overflow-hidden py-[104px] px-16">
      {/* Decorative shapes peeking from edges */}
      <img alt="" src={imgShape8} className="absolute pointer-events-none" style={{ left: -36, top: 63, width: 200, height: 222, transform: 'rotate(94.9deg)' }} />
      <img alt="" src={imgShape6} className="absolute pointer-events-none" style={{ right: -120, top: 380, width: 281, height: 294, transform: 'rotate(124.41deg)' }} />
      ...
      <div className="relative flex flex-col gap-3 items-center justify-center z-10">
        ...
        <div className="flex flex-col gap-9 items-center">
          <p className="font-body font-normal text-[20px] leading-[36px] text-[#fafafa] text-center w-[996px]">
          ...
          <div className="flex gap-7 items-center">
            {cards.map(card => (
              <div key={card.title} className="bg-[#fafafa] relative h-[305px] w-[600px] rounded-2xl">
                <div className="absolute flex flex-col gap-[15px] items-start left-6 top-8 w-[552px]">
