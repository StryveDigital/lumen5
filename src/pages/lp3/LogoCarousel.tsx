// LP3 — "Enterprise teams running on Lumen5"
// Uses the shared marquee component so LP1, LP2, LP3 stay in sync.
...
export default function LogoCarousel() {
  return <LogoMarquee heading="Enterprise teams running on Lumen5" logos={logos} />;
}
